...
class BufferedZipArchive final {
 public:
  ...
  [[nodiscard]] absl::StatusOr<uintptr_t> GetLength() const;
  ...
  // read.
  [[nodiscard]] absl::StatusOr<ZipFile> GetFileByIndex(uintptr_t index)
  ...
  [[nodiscard]] absl::StatusOr<ZipFile> GetFileByIndexRaw(uintptr_t index)
      ABSL_ATTRIBUTE_LIFETIME_BOUND;
...
class BufferedZipStreamReader final {
 public:
  ...
  // is reached.
  [[nodiscard]] absl::StatusOr<std::optional<ZipFile>> ReadNextFile()
      ABSL_ATTRIBUTE_LIFETIME_BOUND;
  // Reads the next file in the stream with an assumed compressed size.
  [[nodiscard]] absl::StatusOr<std::optional<ZipFile>>
  ReadNextFileWithCompressedSize(uint64_t compressed_size)
      ABSL_ATTRIBUTE_LIFETIME_BOUND;
...
[[nodiscard]] absl::StatusOr<std::optional<ZipFile>> ReadZipFileFromStream(
...
[[nodiscard]] absl::StatusOr<std::optional<ZipFile>>
ReadZipFileFromStreamWithCompressedSize(BufferedZipStreamReader& reader
                                            ABSL_ATTRIBUTE_LIFETIME_BOUND,
                                        uint64_t compressed_size);
[[nodiscard]] absl::StatusOr<std::optional<ZipFile>>
ReadZipFileFromStreamWithCompressedSize(FsZipStreamReader& reader
                                            ABSL_ATTRIBUTE_LIFETIME_BOUND,
                                        uint64_t compressed_size);
[[nodiscard]] absl::StatusOr<std::optional<ZipFile>>
ReadZipFileFromStreamWithCompressedSize(ZipStreamReader& reader
                                            ABSL_ATTRIBUTE_LIFETIME_BOUND,
                                        uint64_t compressed_size);
