...
macro_rules! make_vec_type {
    ($type:ty, $vec_name:ident) => {
        ...
        impl $vec_name {
            ...
            /// Inspired by [VecU8::copy_from_raw](https://source.corp.google.com/piper///depot/google3/base/rust/rust_vec_u8.rs;l=55).
            /// # Safety
            ///
            ...
            #[doc="See [std::slice::from_raw_parts](https://doc.rust-lang.org/std/slice/fn.from_raw_parts.html)."]
            #[allow(dead_code)]
            pub unsafe fn copy_from_raw(ptr: *const $type, len: usize) -> $vec_name {
                if len == 0 {
                    return $vec_name::new();
                }
                // We must use standard slice::from_raw_parts to create a slice,
                // then .to_vec() copies the data into a new owned Vec.
